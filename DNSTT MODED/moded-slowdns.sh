...
main() {
    ...
    # ============================================================================
    # STEP 1: CONFIGURE OPENSSH - SECURE VERSION
    # ============================================================================
    print_step "1"
...
# SIMPLIFIED AND CORRECT cipher settings for OpenSSH 9.2
# Removed problematic algorithms
...
if sshd -t; then
    # Restart CORRECT service name (ssh not sshd on Debian)
